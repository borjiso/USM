...
/* =====================================================================
     ...
     where E0[0]=a(km), E0[1]=e,E0[2]=i(���),E0[3]=w(���),E0[4]=���(���),E0[5]=�(���).
	 ...
	 ------------------------------------------------------------------- */
        ;
				/* =====================================================================
					 ...
					 Call: XBL(X,E)
					 Input data: array X[0:5], where X[0]=X(km),X[1]=Y(km),X[2]=Z(km),
...
/* ======================================================================
   ����������: �������� ���������� ��������� ������ E[] � ���������� E1[].
	 ...
	 ����� ���������: KBL(E,E1)
	 ����������� �������:
	 ������� ����������: E={26569.13206,.01,.52359878,.52359878,.52359878,.0},.
		PI=3.14159265359;
	 �������� ����������:
...
/* ======================================================================
   ����������: ���������� �������������, ������������ ���������� ��
	 ...
	 ����������� �������:
	 ������� ����������:
		�=26569.13206, E=.01, SI=sin(PI/6), CI=cos(PI/6),C20=-.001082626848,
		RZ=6378.137.
	 �������� ����������:
...
/* ======================================================================
   ...
   ������� ����������:
    � - ������� ������� (��), E -��������������,CI - ������� ����������,
	 ...
	 ����������� �������:
	 ������� ����������:
	 �=6786., E=.01, CI=cos(PI/4), H=36, GME=398600., CBZ=6.30038738,
